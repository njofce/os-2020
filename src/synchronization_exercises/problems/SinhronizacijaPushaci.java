...
public class SinhronizacijaPushaci {
     ...
     *
     * @param brUcesnici broj na ucesnici vo izvlekuvanjeto
     *
    ...
    class Pusac extends Thread {
        ...
        public void obid(int sostojka) throws InterruptedException {
            ...
            if (sostojki[(sostojka + 1) % 3] && sostojki[(sostojka + 3 - 1) % 3]) {
    ...
    public static void main(String[] args) {
        try {
            SinhronizacijaPushaci izvlekuvanje = new SinhronizacijaPushaci();
            izvlekuvanje.start();
        } catch (Exception ex) {
            ex.printStackTrace();
        }
